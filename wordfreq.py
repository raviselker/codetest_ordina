...
class WordFrequencyAnalyzer:
    ...
    def calc_freq_word(self, word: str) -> int:
        ...
        :param word: The word for which the frequency needs to be returned
    ...
    def calc_most_freq_words(self, n: int):
        ...
        :param n: The number of word frequencies that need to be returned
        :returns: a list of WordFrequency objects
        """
        word_freq_list = [WordFrequency(word, freq) for word, freq in self.__word_freq]
